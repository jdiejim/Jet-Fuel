const Path = require('../models/Path'); // Import the Path model

// returns all paths from specific folder
...
// redirects to long url by first searching the short entry and returingn the long path
...
// creates a new path for a specific folder
exports.create = (req, res, next) => {
  const folder_id = req.params.id;
  const body = Object.assign(req.body, { folder_id });

// checks for missing parameters in the request
