...
exports.getId = exports.renderToParent = exports.renderArrayAppend = exports.renderArray = undefined;
...
var renderArrayAppend = exports.renderArrayAppend = function renderArrayAppend(array, parent, component) {
  (0, _jquery2.default)('#' + parent).html('');
...
var _Collections = __webpack_require__(123);

var _Collections2 = _interopRequireDefault(_Collections);

var _ShortenForm = __webpack_require__(128);
...
var handleTabClass = function handleTabClass(tab) {
  (0, _jquery2.default)('.tab').removeClass('active-tab');
  (0, _jquery2.default)('#' + tab).addClass('active-tab');
};

var renderView = function renderView(tab) {
  switch (tab) {
    case 'tab-1':
...
var Collections = function () {
  ...
  _createClass(Collections, [{
    ...
    value: function unMount() {
      ...
      (0, _jquery2.default)('#collections-paths-wrapper').removeClass('show');
    }
  }, {
    key: 'loadEvents',
    value: function loadEvents() {
      (0, _jquery2.default)('#collections-folders').on('click', '.folder-cell', this.loadUrls);
      (0, _jquery2.default)('#sorting-buttons').on('click', this.sortDate);
    }
  }, {
    key: 'loadUrls',
    value: function loadUrls(_ref) {
      ...
      (0, _jquery2.default)('#collections-paths-wrapper').addClass('show');
      (0, _jquery2.default)('#collections-paths').addClass('show');
      (0, _jquery2.default)('#sorting-buttons').addClass('show');
      this.fetchPaths(id);
    }
  }, {
    key: 'sortDate',
    value: function sortDate(e) {
      var id = (0, _jquery2.default)(e.target).prop('id');

      (0, _jquery2.default)('#collections-paths').html('');
      switch (id) {
        case 'up':
          (0, _helpers.renderArray)(this.paths, 'collections-paths', this.pathCell);
          break;
        case 'down':
          (0, _helpers.renderArrayAppend)(this.paths, 'collections-paths', this.pathCell);
          break;
      }
    }
  }, {
...
// module
exports.push([module.i, "@keyframes appear {\n  from {\n    transform: scaleY(0); }\n  to {\n    transform: scaleY(100%); } }\n\n.collections-wrapper {\n  display: none;\n  justify-content: center;\n  width: 80%;\n  margin: 100px auto;\n  height: 400px;\n  animation: appear 0.2s;\n  overflow: hidden; }\n\n.collections-folders {\n  flex-direction: column;\n  width: 100%;\n  height: 90%;\n  box-shadow: inset 0px -11px 8px -10px #FFF;\n  overflow: scroll; }\n\n.collections-paths-wrapper {\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  width: 100%;\n  height: 90%;\n  margin-top: 10px;\n  margin-left: 20px;\n  animation: appear 0.2s;\n  overflow: scroll; }\n\n.sorting-buttons {\n  display: none;\n  justify-content: flex-end;\n  align-items: center; }\n\n#up {\n  background-image: url(" + __webpack_require__(136) + "); }\n\n#down {\n  background-image: url(" + __webpack_require__(135) + "); }\n\n.sorting-btn {\n  width: 30px;\n  height: 30px;\n  background-position: center;\n  background-repeat: no-repeat;\n  background-size: contain;\n  margin: 5px 10px; }\n  .sorting-btn:hover {\n    transform: scale(1.2); }\n\n.collection-icon {\n  width: 30px;\n  height: 30px;\n  margin-right: 10px;\n  background-image: url(" + __webpack_require__(121) + ");\n  background-position: center;\n  background-repeat: no-repeat;\n  background-size: contain; }\n\n.folder-cell {\n  display: flex;\n  align-items: center;\n  padding: 40px 20px;\n  width: 100%;\n  border-bottom: 1px solid #BDBDBD;\n  cursor: pointer; }\n  .folder-cell:hover {\n    background-color: rgba(0, 0, 0, 0.5); }\n\n.folder-title {\n  color: #FFF;\n  font-size: 30px;\n  font-weight: lighter; }\n\n.collections-folders-title {\n  margin-bottom: 10px;\n  color: #FFF;\n  font-size: 30px;\n  font-weight: lighter;\n  text-align: center; }\n\n.collections-folders-wrapper {\n  width: 50%;\n  height: 100%; }\n\n.collections-paths {\n  display: none;\n  flex-direction: column;\n  justify-content: center;\n  width: 100%;\n  max-height: 100%;\n  padding: 20px;\n  animation: appear 0.2s;\n  border: none;\n  border-top: 1px solid #FFF;\n  border-bottom: 1px solid #FFF;\n  overflow: scroll; }\n\n.path-cell {\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  padding: 40px 20px;\n  height: 50px;\n  width: 100%;\n  border-bottom: 1px solid #BDBDBD;\n  color: #FFF; }\n\n.path-title {\n  color: #FFF;\n  font-size: 16px;\n  font-weight: normal; }\n\n.path-link {\n  margin: 0 0 5px;\n  color: #FFF;\n  font-size: 16px;\n  font-weight: lighter;\n  text-decoration: none;\n  cursor: pointer; }\n  .path-link:hover {\n    color: #7ac3d6; }\n  .path-link:visited {\n    color: #FFF; }\n\n.path-date {\n  align-self: flex-end;\n  color: #FFF;\n  font-size: 12px;\n  font-weight: lighter; }\n", "", {"version":3,"sources":["/Users/JDJim/Documents/Turing/projects/mod4/jet-fuel/src/views/styles/src/views/styles/Collections.scss","/Users/JDJim/Documents/Turing/projects/mod4/jet-fuel/src/views/styles/src/utils/_palette.scss"],"names":[],"mappings":"AAEA;EACE;IAAO,qBAAoB,EAAA;EAC3B;IAAO,wBAAuB,EAAA,EAAA;;AAGhC;EACE,cAAa;EACb,wBAAuB;EACvB,WAAU;EACV,mBAAkB;EAClB,cAAa;EAEb,uBAAsB;EACtB,iBAAgB,EACjB;;AAED;EACE,uBAAsB;EACtB,YAAW;EACX,YAAW;EAEX,2CAA0C;EAC1C,iBAAgB,EACjB;;AAED;EACE,cAAa;EACb,uBAAsB;EACtB,wBAAuB;EACvB,YAAW;EACX,YAAW;EACX,iBAAgB;EAChB,kBAAiB;EACjB,uBAAsB;EAEtB,iBAAgB,EACjB;;AAED;EACE,cAAa;EACb,0BAAyB;EACzB,oBAAmB,EACpB;;AAED;EACE,gDAA0C,EAC3C;;AAED;EACE,gDAA4C,EAC7C;;AAED;EACE,YAAW;EACX,aAAY;EACZ,4BAA2B;EAC3B,6BAA4B;EAC5B,yBAAwB;EACxB,iBAAgB,EAIjB;EAVD;IAQI,sBAAqB,EACtB;;AAGH;EACE,YAAW;EACX,aAAY;EACZ,mBAAkB;EAClB,gDAA8C;EAC9C,4BAA2B;EAC3B,6BAA4B;EAC5B,yBAAwB,EACzB;;AAED;EACE,cAAa;EACb,oBAAmB;EACnB,mBAAkB;EAClB,YAAW;EACX,iCC1E4B;ED2E5B,gBAAe,EAIhB;EAVD;IAQI,qCAAoC,EACrC;;AAGH;EACE,YAAW;EACX,gBAAe;EACf,qBAAoB,EACrB;;AAED;EACE,oBAAmB;EACnB,YAAW;EACX,gBAAe;EACf,qBAAoB;EACpB,mBAAkB,EACnB;;AAED;EACE,WAAU;EACV,aAAY,EACb;;AAED;EACE,cAAa;EACb,uBAAsB;EACtB,wBAAuB;EACvB,YAAW;EACX,iBAAgB;EAChB,cAAa;EACb,uBAAsB;EACtB,aAAY;EACZ,2BAA0B;EAC1B,8BAA6B;EAE7B,iBAAgB,EACjB;;AAgBD;EACE,cAAa;EACb,uBAAsB;EACtB,wBAAuB;EACvB,mBAAkB;EAClB,aAAY;EACZ,YAAW;EACX,iCCxI4B;EDyI5B,YAAW,EACZ;;AAED;EACE,YAAW;EACX,gBAAe;EACf,oBAAmB,EACpB;;AAED;EACE,gBAAe;EACf,YAAW;EACX,gBAAe;EACf,qBAAoB;EACpB,sBAAqB;EACrB,gBAAe,EAOhB;EAbD;IAQI,eAAc,EACf;EATH;IAWI,YAAW,EACZ;;AAGH;EACE,qBAAoB;EACpB,YAAW;EACX,gBAAe;EACf,qBAAoB,EACrB","file":"Collections.scss","sourcesContent":["@import \"../../utils/palette\";\n\n@keyframes appear {\n  from { transform: scaleY(0); }\n  to   { transform: scaleY(100%); }\n}\n\n.collections-wrapper {\n  display: none;\n  justify-content: center;\n  width: 80%;\n  margin: 100px auto;\n  height: 400px;\n  // background-color: red;\n  animation: appear 0.2s;\n  overflow: hidden;\n}\n\n.collections-folders {\n  flex-direction: column;\n  width: 100%;\n  height: 90%;\n  // background-color: blue;\n  box-shadow: inset 0px -11px 8px -10px #FFF;\n  overflow: scroll;\n}\n\n.collections-paths-wrapper {\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  width: 100%;\n  height: 90%;\n  margin-top: 10px;\n  margin-left: 20px;\n  animation: appear 0.2s;\n  // background-color: blue;\n  overflow: scroll;\n}\n\n.sorting-buttons {\n  display: none;\n  justify-content: flex-end;\n  align-items: center;\n}\n\n#up {\n  background-image: url(../../assets/up.svg);\n}\n\n#down {\n  background-image: url(../../assets/down.svg);\n}\n\n.sorting-btn {\n  width: 30px;\n  height: 30px;\n  background-position: center;\n  background-repeat: no-repeat;\n  background-size: contain;\n  margin: 5px 10px;\n  &:hover {\n    transform: scale(1.2);\n  }\n}\n\n.collection-icon {\n  width: 30px;\n  height: 30px;\n  margin-right: 10px;\n  background-image: url(../../assets/folder.svg);\n  background-position: center;\n  background-repeat: no-repeat;\n  background-size: contain;\n}\n\n.folder-cell {\n  display: flex;\n  align-items: center;\n  padding: 40px 20px;\n  width: 100%;\n  border-bottom: 1px solid $divider-color;\n  cursor: pointer;\n  &:hover {\n    background-color: rgba(0, 0, 0, 0.5);\n  }\n}\n\n.folder-title {\n  color: #FFF;\n  font-size: 30px;\n  font-weight: lighter;\n}\n\n.collections-folders-title {\n  margin-bottom: 10px;\n  color: #FFF;\n  font-size: 30px;\n  font-weight: lighter;\n  text-align: center;\n}\n\n.collections-folders-wrapper {\n  width: 50%;\n  height: 100%;\n}\n\n.collections-paths {\n  display: none;\n  flex-direction: column;\n  justify-content: center;\n  width: 100%;\n  max-height: 100%;\n  padding: 20px;\n  animation: appear 0.2s;\n  border: none;\n  border-top: 1px solid #FFF;\n  border-bottom: 1px solid #FFF;\n  // background-color: red;\n  overflow: scroll;\n}\n\n// .collections-paths {\n//   justify-content: center;\n//   flex-direction: column;\n//   width: 100%;\n//   height: 90%;\n//   margin-top: 10px;\n//   margin-left: 20px;\n//   animation: appear 0.2s;\n//   // background-color: blue;\n//   border: 1px solid #FFF;\n//   overflow: scroll;\n// }\n\n\n.path-cell {\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  padding: 40px 20px;\n  height: 50px;\n  width: 100%;\n  border-bottom: 1px solid $divider-color;\n  color: #FFF;\n}\n\n.path-title {\n  color: #FFF;\n  font-size: 16px;\n  font-weight: normal;\n}\n\n.path-link {\n  margin: 0 0 5px;\n  color: #FFF;\n  font-size: 16px;\n  font-weight: lighter;\n  text-decoration: none;\n  cursor: pointer;\n  &:hover {\n    color: #7ac3d6;\n  }\n  &:visited {\n    color: #FFF;\n  }\n}\n\n.path-date {\n  align-self: flex-end;\n  color: #FFF;\n  font-size: 12px;\n  font-weight: lighter;\n}\n","$primary-color-dark:   #455A64;\n$primary-color:        #607D8B;\n$primary-color-light:  #CFD8DC;\n$primary-color-text:   #FFFFFF;\n$accent-color:         #009688;\n$primary-text-color:   #212121;\n$secondary-text-color: #757575;\n$divider-color:        #BDBDBD;\n"],"sourceRoot":""}]);
...
var ShortenForm = function () {
  function ShortenForm() {
    _classCallCheck(this, ShortenForm);
  ...
  _createClass(ShortenForm, [{
    ...
    value: function mount() {
      ...
      (0, _jquery2.default)('.shorten-folders-wrapper').removeClass('shorten-folders-wrapper-show');
      (0, _jquery2.default)('#input-title').val('');
      (0, _jquery2.default)('#input-path').val('');
    }
  }, {
    key: 'unMount',
    value: function unMount() {
      (0, _jquery2.default)('#shorten-wrapper').removeClass('show');
    }
  }, {
    key: 'loadEvents',
    value: function loadEvents() {
      (0, _jquery2.default)('#save-folder').on('click', this.saveFolder);
      (0, _jquery2.default)('#shorten-folders').on('click', '.save-btn', this.savePath);
      (0, _jquery2.default)('#input-title').on('keyup', this.validate);
      (0, _jquery2.default)('#input-path').on('keyup', this.validate);
    }
  }, {
    key: 'validate',
    value: function validate() {
      if ((0, _jquery2.default)('#input-path').val() !== '' && (0, _jquery2.default)('#input-title').val() !== '') {
        (0, _jquery2.default)('.shorten-folders-wrapper').addClass('shorten-folders-wrapper-show');
      } else {
        (0, _jquery2.default)('.shorten-folders-wrapper').removeClass('shorten-folders-wrapper-show');
      }
    }
    ...
    key: 'savePath',
    value: function savePath(e) {
      var id = (0, _helpers.getId)((0, _jquery2.default)(e.target).parent().prop('id'));
      var title = (0, _jquery2.default)('#input-title');
      var path = (0, _jquery2.default)('#input-path');
    ...
    key: 'postPath',
    value: function postPath(id, body) {
      var _this = this;
    ...
    key: 'saveFolder',
    value: function saveFolder() {
      var input = (0, _jquery2.default)('#input-folder');
      var name = input.val();

      this.postFolder({ name: name });
      this.clearInputs(input);
    }
  }, {
    key: 'postFolder',
    value: function postFolder(body) {
      var _this2 = this;
    ...
    value: function fetchFolders() {
      ...
      fetch('api/v1/folders').then(function (res) {
        ...
        (0, _helpers.renderArray)(folders, 'shorten-folders', _this3.folderCell);
    ...
    key: 'appendShort',
    value: function appendShort(_ref) {
